...
; JMPP Jump-Table for key presses
                 .DB <wait_key       ; $86 ; ??? this is pointing to the wait_key function
                 .DB <digit_handler  ; $D1 ; key '0'
                 .DB <digit_handler  ; $D1 ; key '1'
                 .DB <digit_handler  ; $D1 ; key '2'
                 .DB <digit_handler  ; $D1 ; key '3'
                 .DB <digit_handler  ; $D1 ; key '4'
                 .DB <digit_handler  ; $D1 ; key '5'
                 .DB <digit_handler  ; $D1 ; key '6'
                 .DB <digit_handler  ; $D1 ; key '7'
                 .DB <digit_handler  ; $D1 ; key '8'
                 .DB <digit_handler  ; $D1 ; key '9'
                 .DB <out_handler_trampoline  ; $21 ; key 'OUT'
                 .DB <inp_handler    ; $EB ; key 'INP'
                 .DB <cal_handler_trampoline; $23 ; key 'CAL'
                 .DB <step_handler_trampoline; $25 ; key 'STEP'
                 .DB <wait_key ; $86 ; key 'STP'
                 .DB <run_handler_trampoline; $1F ; key 'RUN'
                 .DB <cas_handler_trampoline; $27 ; key 'CAS'
                 .DB <clr_handler    ; $c3 ; key 'CLR'
                 .DB <pc_handler ; $98 ; key 'PC'
                 .DB <acc_handler ; $BF ; key 'ACC'
...
; Dispatch table for opcodes
                 .DB  <opcode_INVALID_trampoline  ; $19   ;  opcode 00
                 .DB  <opcode_HLT       ; $34   ;  opcode 01: HLT
                 .DB  <opcode_ANZ       ; $eb   ;  opcode 02: ANZ
                 .DB  <opcode_VZG       ; $7b   ;  opcode 03: VZG
                 .DB  <opcode_AKO       ; $46   ;  opcode 04: AKO
                 .DB  <opcode_LDA       ; $5f   ;  opcode 05: LDA
                 .DB  <opcode_ABS       ; $4f   ;  opcode 06: ABS
                 .DB  <opcode_ADD       ; $f3   ;  opcode 07: ADD
                 .DB  <opcode_SUB_trampoline       ; $1b   ;  opcode 08: SUB
                 .DB  <opcode_SPU       ; $8f   ;  opcode 09: SPU
                 .DB  <opcode_VGL_trampoline       ; $1d   ;  opcode 10: VGL
                 .DB  <opcode_SPB       ; $96   ;  opcode 11: SPB
                 .DB  <opcode_VGR_trampoline       ; $1f   ;  opcode 12: VGR
                 .DB  <opcode_VKL_trampoline       ; $21   ;  opcode 13: VKL
                 .DB  <opcode_NEG       ; $a6   ;  opcode 14: NEG
                 .DB  <opcode_UND       ; $c1   ;  opcode 15: UND
                 .DB  <opcode_P1E_trampoline       ; $23   ;  opcode 16: P1E
                 .DB  <opcode_P1A_trampoline       ; $25   ;  opcode 17: P1A
                 .DB  <opcode_P2A_trampoline       ; $27   ;  opcode 18: P2A
                 .DB  <opcode_LIA       ; $6d   ;  opcode 19: LIA
                 .DB  <opcode_AIS       ; $74   ;  opcode 20: AIS
                 .DB  <opcode_SIU       ; $9f   ;  opcode 21: SIU
                 .DB  <opcode_P3E_trampoline ; $29   ;  opcode 22: P3E
                 .DB  <opcode_P4A_trampoline       ; $2b   ;  opcode 23: P4A
                 .DB  <opcode_P5A_trampoline       ; $2d   ;  opcode 24: P5A
